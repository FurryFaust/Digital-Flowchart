...
$(document).ready(function() {
        ...
        if(expression != "") {
            ...
            for(var i = 0; i != length; i++) {
                ...
                while(proccessing.indexOf("1+1") != -1 || proccessing.indexOf("1+0") != -1
                    ...
                    || proccessing.indexOf("1^1") != -1 || proccessing.indexOf("0^1") != -1
                    || proccessing.indexOf("1^0") != -1 || proccessing.indexOf("0^0") != -1) {
    ...
    function getTextureFor(sequence, index) {
